...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getTextMessageUser1(String text){
        return new Message(getRandomId(),getUser1(),text);
    }

    public static Message getTextMessageUser2(String text){
        return new Message(getRandomId(),getUser2(),text);
    }
